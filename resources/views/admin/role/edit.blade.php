                ...
                <div class="col-md-12">
                    <div class="m-subheader px-0 m-subheader--top">
                        <div class="d-flex align-items-center">
                            <h1 class="m-subheader__title m-subheader__title--separator">Update Role</h1>
                    ...
                    <div class="m-portlet m-portlet--mobile">
                        <form id="edit-role" role="form" method="post" class="m-form m-form--rows m-form--label-align-right" action="{{route('update-role',$role['id'])}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                                <div class="m-form__actions px-0">
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="btn-list">
                                                <button type="submit" id="edit_role" class="btn btn-primary">Update</button>
