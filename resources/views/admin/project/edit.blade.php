    ...
    <div class="col-md-8 list">
        <div class="col-md-12">
            ...
            <div class="m-portlet m-portlet--mobile">
                <form id="edit-project" role="form" method="post" class="m-form m-form--rows m-form--label-align-right"
                      action="{{route('update-project',$project['id'])}}" enctype="multipart/form-data">
                    @csrf
                    <div class="m-portlet__body m-portlet__body--spaced">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-sm-4 form-group">
                                ...
                                <div class="m-input-icon m-input-icon--right">
                                    <select title="Select Layout" data-live-search="true"
