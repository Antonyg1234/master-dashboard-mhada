        ...
        <div class="col-md-12">
            <div class="m-subheader px-0 m-subheader--top">
                <div class="d-flex align-items-center">
                    <h1 class="m-subheader__title m-subheader__title--separator">Add Project</h1>
            ...
            <div class="m-portlet m-portlet--mobile">
                <form id="add-project" role="form" method="post" class="m-form m-form--rows m-form--label-align-right"
