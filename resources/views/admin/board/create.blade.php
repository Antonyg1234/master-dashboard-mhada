                ...
                <div class="col-md-12">
                    <div class="m-subheader px-0 m-subheader--top">
                        <div class="d-flex align-items-center">
                            <h1 class="m-subheader__title m-subheader__title--separator">Add Board</h1>
                    ...
                    <div class="m-portlet m-portlet--mobile">
                        <form id="add-board" role="form" method="post" class="m-form m-form--rows m-form--label-align-right" action="{{route('store-board')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="m-portlet__body m-portlet__body--spaced">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <div class="m-input-icon m-input-icon--right">
                                            <input type="text" id="icon_url" name="icon_url" class="form-control form-control--custom m-input"  value="{{ old('icon_url') }}">
                            ...
                            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                                <div class="m-form__actions px-0">
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="btn-list">
                                                <button type="submit" id="add_board" class="btn btn-primary">Save</button>
